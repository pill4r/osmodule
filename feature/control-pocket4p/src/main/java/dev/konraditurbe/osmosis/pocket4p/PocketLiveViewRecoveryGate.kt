...
internal class PocketLiveViewRecoveryGate(
    ...
    private var lastVideoAtMs: Long? = null
    ...
    fun tick(nowMs: Long): Action {
        val videoReference = lastVideoAtMs ?: startedAtMs
        ...
        val requiredEnableGap = if (lastVideoAtMs == null && recoveryEnables == 0) {
