 ...
 * make [dev.pillar.osmodule.camera.ManifestGoldenTest.CANON] emit the new lines (it already
...
class ManifestGoldenTest {
    ...
    private fun canon(files: List<dev.pillar.osmodule.core.CameraFile>) = files.map {
